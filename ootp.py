...
print("Let's do some database stuff!\nOnce you enter the path to your data files, we'll check to see if you already have database login information stored.")
input_path = input("What is the location of your data files?  (Full Path, please) ")
path = Path(input_path)

############################################
# Check if database and config data exists #
############################################
database = input("What is the name of your database? ")
...
if database in config.sections():
    ...
    try:
        ...
        if mysql.connector.connection:
            message = 'Credentials Accepted.\nCreating Database...'
    except:  # TODO need to make this better...
        print('Your credentials were not accepted. \nPlease check them and try again.')
...
for file in just_filenames:
    if file in tables:
        ...
        with open(path / file_name, 'r') as f:
            ...
            mydb.commit()
            print(file + " data has been loaded to database")
